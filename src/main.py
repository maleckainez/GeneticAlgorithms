...
np.random.seed(2137)
# f = open("dane AG 2/low-dimensional/f1_l-d_kp_10_269")#("dane AG 2/large_scale/knapPI_1_100_1000_1")
# content = f.read()
...
slownik = utils.load_data("../dane AG 2/large_scale/knapPI_1_100_1000_1")
amountOfThings = len(slownik)
